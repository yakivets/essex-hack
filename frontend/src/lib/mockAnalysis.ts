...
const C = (id: string, category: string, risk: "high" | "medium" | "low", quote: string, plain: string, why?: string, fix?: string, bench?: { percentile: number; typical: string }) => ({
  id, category, risk_level: risk, quote, plain_english: plain, why_risky: why, suggested_fix: fix, benchmark: bench,
});
...
export const mockAnalysis: AnalysisResult = {
  ...
  clauses: [
    C("c1", "Parties & Term", "low", "This Agreement is entered into as of the Effective Date between Acme Corp and Globex SaaS for an initial term of twenty-four (24) months.", "Defines who's signing and the 24-month starting term."),
    C("c2", "Auto-renewal", "high", "This Agreement shall automatically renew for successive twenty-four (24) month periods unless either party provides written notice of non-renewal at least thirty (30) days prior to the end of the then-current term.", "Renews for another 2 years unless you cancel 30 days before term ends.", "30 days is a short window for a 2-year commitment; most teams miss it.", "Shorten renewal to 12 months and extend notice to 60–90 days.", { percentile: 82, typical: "12-month renewal with 60-day notice" }),
    C("c3", "Fees", "low", "Customer shall pay the fees set forth in the applicable Order Form.", "Standard fee reference to the Order Form."),
    C("c4", "Indemnification", "high", "Customer shall indemnify, defend, and hold harmless Provider from any and all third-party claims arising out of Customer's use of the Services.", "You cover the vendor for any third-party lawsuit related to your use — with no cap.", "An uncapped indemnity can dwarf the contract's value if a claim ever materialises.", "Cap indemnity at fees paid in the prior 12 months and carve out vendor IP claims.", { percentile: 71, typical: "Mutual indemnity capped at 12 months of fees" }),
    C("c5", "Liability Cap", "medium", "Provider's total liability shall not exceed the fees paid in the three (3) months preceding the claim.", "Vendor's max payout if they mess up is 3 months of fees.", "A 3-month cap is unusually low and asymmetric to your uncapped indemnity.", "Raise to 12 months of fees and make caps mutual.", { percentile: 65, typical: "12 months of fees" }),
    C("c6", "Price Changes", "medium", "Provider may modify pricing upon thirty (30) days' written notice to Customer.", "Vendor can raise prices mid-term with 30 days' notice.", "Removes budget certainty during the term and pressures renewal.", "Lock pricing for the initial term; cap renewal increases at CPI or 5%."),
    C("c7", "Data & Privacy", "low", "Provider shall process Customer Data in accordance with its Privacy Policy.", "Vendor follows its own privacy policy when handling your data."),
    C("c8", "Service Levels", "medium", "Provider targets 99.9% monthly uptime, excluding scheduled maintenance.", "Uptime target with no service credits if missed.", "A target without a remedy is marketing, not a contract right.", "Add tiered service credits (e.g. 10/25/100% of monthly fee)."),
    C("c9", "Governing Law", "low", "This Agreement shall be governed by the laws of the State of Delaware.", "Disputes are settled under Delaware law in vendor's home turf."),
    C("c10", "Termination", "medium", "Either party may terminate this Agreement for material breach upon thirty (30) days' written notice and opportunity to cure.", "Either side can exit for a serious breach after a 30-day cure period.", "Termination for convenience isn't permitted — you're locked in absent breach.", "Add termination for convenience with 60 days' notice."),
  ],
  document: {
    html: `
